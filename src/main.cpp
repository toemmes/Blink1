...
// Eigenschaften->C/C++->Allgemein->zusätzliche include verzeichnisse-> C:\Users\thoma\source\repos\Blink1\src;C:\Users\thoma\source\repos\Blink1\inc;%(AdditionalIncludeDirectories)
...
int main(void) 
{
	...
	// projekt->Eigenschaften->Linker->zusätzliche Optiornen-> -lwiringPiDev 
